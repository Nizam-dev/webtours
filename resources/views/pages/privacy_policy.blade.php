        ...
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                ...
                <p class="breadcrumbs"><span class="mr-2"><a href="{{url('/')}}">Home <i
                                class="ion-ios-arrow-forward"></i></a></span> <span>Privay Policy <i
...
<section class="ftco-section services-section mb-5 bg-light">
    <div class="container">
        <div class="row d-flex">
            <div class="col-md-12 order-md-last heading-section pl-md-5 ftco-animate">

                <h1>Privacy Policy for Driver Bali Tour</h1>

                <p>At Driver Bali Tour, accessible from https://driverbalitour.com/, one of our main priorities is the
                    privacy of our visitors. This Privacy Policy document contains types of information that is
                    collected and recorded by Driver Bali Tour and how we use it.</p>
                ...
                <p>Driver Bali Tour follows a standard procedure of using log files. These files log visitors when they
                    ...
                    website, and gathering demographic information. Our Privacy Policy was created with the help of the
                    <a href="https://www.privacypolicyonline.com/privacy-policy-generator/">Privacy Policy
                        Generator</a>.</p>

                <h2>Cookies and Web Beacons</h2>

                <p>Like any other website, Driver Bali Tour uses 'cookies'. These cookies are used to store information
                ...
                <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Driver
                    Bali Tour.</p>

                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                    are used in their respective advertisements and links that appear on Driver Bali Tour, which are
                ...
                <p>Note that Driver Bali Tour has no access to or control over these cookies that are used by
                    third-party advertisers.</p>

                <h2>Third Party Privacy Policies</h2>

                <p>Driver Bali Tour's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                ...
                <p>Driver Bali Tour does not knowingly collect any Personal Identifiable Information from children under
                ...
                <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
                    with regards to the information that they shared and/or collect in Driver Bali Tour. This policy is
